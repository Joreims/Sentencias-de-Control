...
public class Aritmeticos extends javax.swing.JInternalFrame {
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        num4 = Integer.parseInt(tfNum6.getText());
        num5 = Integer.parseInt(tfNum7.getText());
        
        resp = (num1+num2-num3*num4/num5);
    ...
    private void bCalcular5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular5ActionPerformed
        // TODO add your handling code here:
        int num1, num2,num3;      
        num1 = Integer.parseInt(tfNum15.getText());
        num2 = Integer.parseInt(tfNum16.getText());
        num3 = Integer.parseInt(tfNum17.getText());
        double resp1 = Math.pow(num1, num2);
        double resp2 = num2/num3;
        double respf = resp1*resp2;
        JOptionPane.showMessageDialog(null, "La respuesta es: "+respf);
